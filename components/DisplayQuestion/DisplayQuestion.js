...
const DisplayQuestion = ({ question }) => {
  ...
  return (
    <div className="myblock" key={question.question_id}>
      <li className="font-weight-bold mycolor mr-2" dangerouslySetInnerHTML={{ __html: question.question }}></li>
      <div className="options">
        <div>
          <p className="font-weight-bold mycolor mr-2">
            A .
            <div className="ml-2 textColor" dangerouslySetInnerHTML={{ __html: question.optionA }}></div>
          </p>
        </div>
        <div>
          <p  className="font-weight-bold mycolor mr-2">
            B . 
            <div className="ml-2 textColor" dangerouslySetInnerHTML={{ __html: question.optionB }}></div>
          </p>
        </div>
        <div>
          <p  className="font-weight-bold mycolor mr-2">
            C . 
            <div className="ml-2 textColor" dangerouslySetInnerHTML={{ __html: question.optionC }}></div>
          </p>
        </div>
        <div>
          <p  className="font-weight-bold mycolor mr-2"> 
            D . 
            <div className="ml-2 textColor" dangerouslySetInnerHTML={{ __html: question.optionD }}></div>
          </p>
        </div>
      </div>
      {toggleAnswer && (
