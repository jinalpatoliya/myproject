...
export default class Category extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        console.log("Catgeory",category1);
        ...
        if(!validator.isEmpty(category) && data.length==0 &&
                ...
                <div className="col-md-8 mx-auto">
                    ...
                    <form>
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" name="category" placeholder="Enter Category" onChange={this.handleChange} value={this.state.category}/>                           
                        </div>                       
                        <div className="form-group">
