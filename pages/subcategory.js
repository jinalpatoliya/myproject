...
import { insertSubcategory, getsubcategoriesById } from '../actions/subcategory';
...
export default class Subcategory extends Component {
    ...
    handleSubmit = async (e) => {
        ...
        const data=subcategories.filter((cat)=>cat.subcategoryName==subcategory);
        if(data.length>0){
            this.setState({
                Error:"Already Exist Sub Category."
            })
        }
        else{
                ...
                <div className="col-md-8 mx-auto">
                    ...
                    <Category label="Category" name="category_id"  data={this.props.categoryidfi} handlename={this.handleCategory} />
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" name="subcategory" placeholder="Enter Sub Category" onChange={this.handleChange} value={this.state.subcategory} />
                        </div> 
                        <div className="form-group">
                            <label>Sub Category Slug</label>
                            <input type="text" className="form-control" name="subcategorySlug" placeholder="Enter Sub Category Slug" onChange={this.handleSubcategory} value={this.state.subcategorySlug} />
                        </div>                       
