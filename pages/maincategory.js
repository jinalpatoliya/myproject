...
export default class Category extends Component {    
    ...
    handleSubmit = async (e) => {
        e.preventDefault();
        const { mainCategoryName , mainCategorySlug , mainCategoryTitle} = this.state      
        const maincategory ={
            mainCategoryName:mainCategoryName,
            mainCategorySlug:mainCategorySlug,
            mainCategoryTitle:mainCategoryTitle
        }      
        if(!validator.isEmpty(mainCategoryName) && 
                ...
                <div className="col-md-8 mx-auto">
                    ...
                    <form>
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" name="mainCategoryName" placeholder="Enter Category" onChange={this.handleChange} value={this.state.mainCategoryName}/>                           
                        </div>                       
                        <div className="form-group">
                            <label> Main Category Slug</label>
                            <input type="text" className="form-control" name="mainCategorySlug" placeholder="Enter Category Slug" onChange={this.handleSlug} value={this.state.mainCategorySlug}/>
                        </div>
                        <div className="form-group">
                            <label>Main Category Title</label>
                            <input type="text" className="form-control" name="mainCategoryTitle" placeholder="Enter Main Category Tile" onChange={this.handleChangeTitle} value={this.state.mainCategoryTitle}/>                           
                        </div>                       
